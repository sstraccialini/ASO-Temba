...
parser.add_argument('-save_format', type=str, default='npy', choices=['npy', 'npz', 'both'], help='Feature file format to save')
parser.add_argument('-delete_frames', action='store_true', help='Delete frame directory after processing')
parser.add_argument('-delete_video', action='store_true', help='Delete source .mp4 after processing')
